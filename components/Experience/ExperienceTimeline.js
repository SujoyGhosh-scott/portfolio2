    ...
    <ol className="relative border-l border-gray-200 dark:border-gray-700">
      <li className="mb-6 ml-4">
        ...
        >
          <img
            ...
            src="/experience/indpro.png"
            alt=""
          />
          <div className="flex-1">
            <h3 className="font-semibold dark:text-white">Indpro</h3>
            <p className="mb-4 text-sm font-normal text-gray-500 dark:text-gray-400">
              Full time Software Engineer at Indpro.
            </p>
          </div>
        </div>
      </li>
      ...
      <li className="mb-6 ml-4">
        ...
        >
          ...
          <div className="flex-1">
            <p className="mb-4 text-sm font-normal text-gray-500 dark:text-gray-400">
              Completed <strong>MSc</strong> course in Computer Science from{" "}
      ...
      <li className="mb-6 ml-4">
        ...
        >
          ...
          />
          <div className="flex-1">
            <h3 className="font-semibold dark:text-white">Whales Network</h3>
            <p className="mb-4 text-sm font-normal text-gray-500 dark:text-gray-400">
              App Developer
            </p>
          </div>
